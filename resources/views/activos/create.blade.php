...
<div class="main">
    <header class="topbar">
        <div class="topbar-title"><i class="fas fa-plus" style="color:#1e40af; margin-right:8px;"></i> Registrar Nuevo Activo TI</div>
        <div>
                ...
                <div class="form-body">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" value="{{ old('codigo') }}" placeholder="Ej: ACT-001" required>
                            <span class="hint">Debe ser único. Ej: ACT-001, ACT-002...</span>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tipo" required>
                                ...
                                <option value="red" {{ old('tipo') == 'red' ? 'selected' : '' }}>Red</option>
                                <option value="datos" {{ old('tipo') == 'datos' ? 'selected' : '' }}>Datos</option>
                                <option value="servicios" {{ old('tipo') == 'servicios' ? 'selected' : '' }}>Servicios</option>
                                <option value="personas" {{ old('tipo') == 'personas' ? 'selected' : '' }}>Personas</option>
                                <option value="instalaciones" {{ old('tipo') == 'instalaciones' ? 'selected' : '' }}>Instalaciones</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="criticidad" required>
                                ...
                                <option value="baja" {{ old('criticidad') == 'baja' ? 'selected' : '' }}>Baja</option>
                                <option value="media" {{ old('criticidad') == 'media' ? 'selected' : '' }}>Media</option>
                                <option value="alta" {{ old('criticidad') == 'alta' ? 'selected' : '' }}>Alta</option>
                                <option value="critica" {{ old('criticidad') == 'critica' ? 'selected' : '' }}>Crítica</option>
                            </select>
