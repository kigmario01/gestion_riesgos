...
<head>
    ...
    <title>Nueva Evaluación de Riesgo</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}body{font-family:'Inter',sans-serif;background:#f0f4f8;color:#1e293b}
        ...
        .calc-box{background:#f8fafc;border:2px solid #e2e8f0;border-radius:12px;padding:20px;margin-top:4px;text-align:center;transition:all 0.3s}
        .calc-box.critico{background:#fef2f2;border-color:#fecaca}
        .calc-box.alto{background:#fff7ed;border-color:#fed7aa}
        .calc-box.medio{background:#fefce8;border-color:#fef08a}
        .calc-box.bajo{background:#f0fdf4;border-color:#bbf7d0}
        ...
        /* ESCALA */
        .escala-label{display:flex;justify-content:space-between;font-size:10px;color:#94a3b8;margin-top:4px}
    </style>
</head>
<body>
<aside class="sidebar">
...
<div class="main">
    <header class="topbar">
        <div class="topbar-title"><i class="fas fa-calculator" style="color:#1e40af;margin-right:8px;"></i> Nueva Evaluación de Riesgo</div>
        <a href="{{ route('evaluaciones.index') }}" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Volver</a>
    </header>
    <div class="content">
        <div class="form-card">
            <div class="form-header"><h2><i class="fas fa-search"></i> Calcular nivel de riesgo — ISO 27001</h2></div>
